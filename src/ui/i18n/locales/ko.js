export default {
  ...
  "mode.quiz": "퀴즈",
  "quiz.title": "질문",
  "quiz.empty": "아직 질문이 없습니다",
  "quiz.ready": "{n}개 질문 준비됨",
  "quiz.edit": "질문 편집",
  "quiz.howMany": "질문을 몇 개 만들까요?",
  "quiz.next": "다음",
  "quiz.back": "뒤로",
  "quiz.save": "저장",
  "quiz.cancel": "취소",
  ...
  "quiz.a": "답 {n}",
  "quiz.reveal": "답 보기",
  "quiz.progress": "질문 {i} / {n}",
  "quiz.finished": "테스트 완료.",
  "quiz.hint": "질문은 무작위 순서로 읽습니다. 소리 내어 답한 뒤 답을 확인하세요.",
  "quiz.needQuestions": "먼저 질문을 추가하세요.",
  "oss.title": "오픈 소스",
